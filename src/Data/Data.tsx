...
export let products: Product[] = [
    ...
    {
        imageName: 'GCS51.png',
        productDescription: 'A blend of black tea and exotic spices give Starbucks® Chai Brewed Tea its deep color. This polish will give it to your next manicure.',
        productID: 'GCS51',
        productName: 'Chai Tease'
    },
    {
        imageName: 'GCS52.png',
        productDescription: 'The First Lady of Nails is always on trend. This polish is perfectly forumated - just like her Starbucks® Flat White.',
        productID: 'GCS52',
    ...
    {
        imageName: 'GCS56.png',
        productDescription: 'This one\'s a treat! A light grey polish that\'s every bit as cool as your Starbucks® Vanilla Frappucino®.',
        productID: 'GCS56',
    ...
    {
        imageName: 'GCS58.png',
        productDescription: 'Because one cup of Starbucks® is never enough. You\'ll be reaching for your Starbucks Rewards™ Gold Card even more often once you put on this perfectly matched polish.',
        productID: 'GCS58',
        productName: 'Put It On My Gold Card'
    },
    {
        imageName: 'GCS59.png',
        productDescription: 'Taking its color from a Starbucks® Cappuccino is sure to make this polish an instant classic.',
        productID: 'GCS59',
